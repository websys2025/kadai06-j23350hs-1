...
APP_ID = "5686a2027d49b8b8b734dc87acbcf106d9fde206"
API_URL  = "https://api.e-stat.go.jp/rest/3.0/app/json/getStatsData"

params = {
    "appId": APP_ID,
    "statsDataId":"0002122480",
    "metaGetFlg":"Y",
    "cntGetFlg":"N",
    "explanationGetFlg":"Y",
    "annotationGetFlg":"Y",
...
#データの種類は、作物統計調査（政府統計コード：00500215）
#エンドポイントは、API_URL  = "https://api.e-stat.go.jp/rest/3.0/app/json/getStatsData"

#機能は
#・指定年度（例：2023年）の作物統計調査データの取得
#・地域別（全国・都道府県別）での集計データの取得
#・作付面積、収量、収穫量、出荷量などの農業生産関連統計
